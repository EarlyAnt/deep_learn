    ...
    with mp_face_mesh.FaceMesh(
        ...
        for idx, file in enumerate(image_files):
            ...
            for face_landmarks in results.multi_face_landmarks:
                ...
                cv2.imwrite("{}/{}".format(output_folder,
                            file_name), annotated_image)
...
def capture_video():
    ...
    with mp_face_mesh.FaceMesh(
        ...
        while cap.isOpened():
            ...
            print(
                f"object count: {len(results.multi_face_landmarks) if results.multi_face_landmarks else 0}, time: {datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S.%f')[:-3]}")
